function [ PRS, SC, OFDMnumber] = GeneratePRS(cellID, subframeID, PBCHports, DLRBnum, prsRBnum )
%Generate the PRS according to 36.211 R14
%   return PRS modulation symbols, SC index and correspondinig OFDM
%   symbols which are sent on p=6
%   TXnum : PBCH ports
N = 110; 
...
for ofdmIdx = OFDMpattern
    ...
    PRS{1}(:,ofdmIdx == OFDMpattern) = a.';
    SC{1}(:,ofdmIdx == OFDMpattern) = k.';
end
end
